...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('borrows/verify-request/{borrow_code}', [BorrowController::class, 'verifySubmitBorrowRequest']);
    Route::put('borrows/{id}/reject-request', [BorrowController::class, 'rejectBorrowRequest']);
});
