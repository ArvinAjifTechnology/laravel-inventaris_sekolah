                ...
                <form method="POST" action="{{ url('operator/items') }}" class="">
                    ...
                    <div class="form-group">
                        ...
                        <select id="room_id" name="room_id"
                            class="form-control @error('room_id') is-invalid @enderror select2" data-toggle="select2">
                    ...
                    <div class="form-group">
                        ...
                        <select id="condition" name="condition"
                            ...
                            <option value="good" {{ old('condition')=='good' ? 'selected' : '' }}>{{ __('items.Good') }}
                            </option>
                            <option value="fair" {{ old('condition')=='fair' ? 'selected' : '' }}>{{ __('items.Fair') }}
                            </option>
                            <option value="bad" {{ old('condition')=='bad' ? 'selected' : '' }}>{{ __('items.Bad') }}
                            </option>
                        </select>
                        @error('condition')
                        <div class="invalid-feedback">{{ $message }}</div>
